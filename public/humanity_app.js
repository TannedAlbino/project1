...
App.prototype.getHumanity = function(){
	var url = "https://api.giphy.com/v1/gifs/search?limit=10&q=faith-in-humanity-restored&api_key=dc6zaTOxFJmzC"
	var that = this
	$.ajax({
...
App.prototype.getHumanityPic = function(){
	var url = "https://api.instagram.com/v1/tags/humanityrestored/media/recent?client_id=e8e933f52cdb49cca32336215450ee2f&count=8"
	var that = this
