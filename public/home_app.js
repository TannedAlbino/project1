...
App.prototype.getFunny = function(){
	var url = "https://api.giphy.com/v1/gifs/search?limit=10&q=halloween-pets&api_key=dc6zaTOxFJmzC"
	var that = this
	$.ajax({
...
App.prototype.getFunnyPic = function(){
	var url = "https://api.instagram.com/v1/tags/halloweenbaby/media/recent?client_id=e8e933f52cdb49cca32336215450ee2f&count=8"
	var that = this
